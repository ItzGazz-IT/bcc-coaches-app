  ...
  const getScheduleForDay = (day) => {
    ...
    const dayFixtures = fixtures
      ...
      .map(fixture => ({
        ...
        time: fixture.time || getDefaultKickoffTime() || "TBC",
        location: fixture.venue || (fixture.homeAway === "Home" ? "Home Ground" : "Away"),
        description: `${fixture.competition || "Friendly"} - Squad`,
        icon: Trophy,
    ...
    <div className="flex-1 p-4 md:p-6 bg-gray-50 min-h-screen overflow-y-auto">
      <div className="max-w-7xl mx-auto">
        <div className="mb-4 md:mb-6">
          ...
          <p className="text-sm md:text-base text-gray-600 hidden md:block">Team schedule</p>
        </div>
